package ru.kazan.itis.bikmukhametov.vkeducation.domain.appdetails

import androidx.compose.runtime.Composable
import androidx.compose.ui.res.stringResource
import ru.kazan.itis.bikmukhametov.vkeducation.R

object AppDetailsMocks {

    @Composable
    fun heroGuild(): AppDetails = AppDetails(
        id = "fa2e31b8-1234-4cf7-9914-108a170a1b01",
        name = stringResource(R.string.app_details_mock_hero_guild_name),
        developer = stringResource(R.string.app_details_mock_hero_guild_developer),
        ...
        description = stringResource(R.string.app_details_mock_hero_guild_description),
    )

    @Composable
    fun all(): List<AppDetails> = listOf(heroGuild())
}
